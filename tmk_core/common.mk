...
#     TMK_COMMON_SRC += $(PLATFORM_COMMON_DIR)/eeprom_sn32.c
#     TMK_COMMON_SRC += $(PLATFORM_COMMON_DIR)/flash_sn32.c
#     TMK_COMMON_DEFS += -DEEPROM_EMU_SN32F240B
#     TMK_COMMON_DEFS += -DSN32_EEPROM_ENABLE
  else
